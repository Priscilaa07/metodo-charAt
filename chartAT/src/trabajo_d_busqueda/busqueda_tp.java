package trabajo_d_busqueda;
import java.util.Scanner;
public class busqueda_tp {
	...
	public static void main (String args []) {
		...
		char posicion = apellido.charAt(n1-1);// la variable char posicion tomara el valor de un caracter del string segun el valor de n1 puesta en el charAT
